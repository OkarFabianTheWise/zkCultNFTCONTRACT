...
// Create deployer object and load the artifact of the contract you want to deploy.
  ...
  const nftCollection = "0x7D24d59d5968677F31Ab9c25941F6909585965AB"; // replace with actual address of NFT collection
  const rewardToken = "0xB3d6Fb1BC452c6f87875832EEd00e315914969e6"; // actual address of reward token
  const nftValueTokenAddr = "0x5Eb1Da89177A65d4Ab781d83E3eB9E551592183F"; // replace with actual address of NFT value token
  const amountOfValueToken = 0; // replace with actual amount of value token
  const nftTokenLogo = "https://example.com/nfttokenlogo.png"; //URL OF LOGO
  const rewardTokenLogo = "https://example.com/rewardtokenlogo.png"; // URL OF REWARD TOKEN LOGO
  const websiteURL = "https://zkcult.monster"; //URL OF WEBSITE
  const lockDuration = 1; // REPLACE WITH ACTUAL LOCK DURATION IN DAYS
  const rewardPerDay = 1; // REPLACE WITH ACTUAL REWARD PER DAY
  const poolOwner = "0x8afACaec5DAd5F03cB3913eA2Ab1609D937b3ff3"; // replace with actual address of pool owner
  const endTime = 0//Math.floor(Date.now() / 1000) + 3600; set end time to 1 hour from now
